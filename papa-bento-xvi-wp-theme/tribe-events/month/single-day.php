...
<div id="tribe-events-daynum-<?php echo $day['daynum-id'] ?>">
	...
	<?php if ( $day['total_events'] > 0 && tribe_events_is_view_enabled( 'day' ) ) : ?>
		...
		<a href="<?php echo esc_url( tribe_get_day_link( $day['date'] ) ); ?><?php echo $languageURL; ?>" aria-label="<?php echo esc_attr( $view_day_label ); ?>">
			<?php echo $day['daynum'] ?>
		</a>
	<?php else : ?>
		<?php echo $day['daynum'] ?>
...
<?php if ( $day['view_more'] ) : ?>
	<div class="tribe-events-viewmore">
		...
		?>
		<a href="<?php echo esc_url( $day['view_more'] ); ?><?php echo $languageURL; ?>" aria-label="<?php echo esc_attr( $view_all_aria_label ); ?>">
