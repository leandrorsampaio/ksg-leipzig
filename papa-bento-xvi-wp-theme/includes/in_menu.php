...
<div class="sidebar">
    ...
    <a class="sidebar__top" href="<?php echo esc_url( home_url( '/' ) ) . $languageURL; ?>">
      <li>Homepage</li>
    </a>


    <a href="<?php echo get_permalink($news) . $languageURL; ?>">
      <li>News</li>
    </a>

    <a href="<?php echo esc_url( home_url( '/kalender' ) ) . $languageURL; ?>">
        <li>
          <?php
    ...
    <a><li id="uberuns" style="cursor:pointer;">
    <?php
        //get field object PAGE_TITLE from the specific page ID
    ...
    <ul id="uberuns-child" style="display:none;">

        <a href="<?php echo get_permalink($uberuns) . $languageURL; ?>">
            <li class="child"><?php
        //get field object PAGE_TITLE from the specific page ID
            $uberuns_title = get_field_object('title_en', $uberuns);
        //if language is English, displays the custom field
        ...
        <a href="<?php echo get_permalink($personen) . $languageURL; ?>">
            <li class="child">
            <?php
        //get field object PAGE_TITLE from the specific page ID
        ...
        <a href="<?php echo get_permalink($unsere) . $languageURL; ?>">
            <li class="child">
            <?php
        //get field object PAGE_TITLE from the specific page ID
...
$("#uberuns").mouseup(function(){
    ...
    <a><li id="gemen" style="cursor:pointer;">
    <?php
        //get field object PAGE_TITLE from the specific page ID
    ...
    <ul id="gemen-child" style="display:none;">
        <a href="<?php echo get_permalink($gemeindeleben) . $languageURL; ?>">
            <li class="child"><?php
        //get field object PAGE_TITLE from the specific page ID
            $gemeindeleben_title = get_field_object('title_en', $gemeindeleben);
        //if language is English, displays the custom field
        ...
        <a href="<?php echo get_permalink($heiligeMesse) . $languageURL; ?>">
            <li class="child"><?php
        //get field object PAGE_TITLE from the specific page ID
        ...
        <a href="<?php echo get_permalink($musik) . $languageURL; ?>">
            <li class="child"><?php
        //get field object PAGE_TITLE from the specific page ID
        ...
        <a href="<?php echo get_permalink($laudes) . $languageURL; ?>">
            <li class="child"><?php
        //get field object PAGE_TITLE from the specific page ID
        ...
        <a href="<?php echo get_permalink($chor) . $languageURL; ?>">
            <li class="child"><?php
        //get field object PAGE_TITLE from the specific page ID
        ...
        <a href="<?php echo get_permalink($internationalerAbend) . $languageURL; ?>">
            <li class="child"><?php
        //get field object PAGE_TITLE from the specific page ID
        ...
        <a href="<?php echo get_permalink($soziales) . $languageURL; ?>">
            <li class="child"><?php
        //get field object PAGE_TITLE from the specific page ID
        ...
        <a href="<?php echo get_permalink($uberregionales) . $languageURL; ?>">
            <li class="child"><?php
        //get field object PAGE_TITLE from the specific page ID
        ...
        <a href="<?php echo get_permalink($okumene) . $languageURL; ?>">
            <li class="child"><?php
        //get field object PAGE_TITLE from the specific page ID
...
$("#gemen").mouseup(function(){
    ...
    <a href="<?php echo get_permalink($freundeskreis) . $languageURL; ?>">
        <li><?php
        //get field object PAGE_TITLE from the specific page ID
    ...
    <a href="<?php echo get_permalink($datens) . $languageURL; ?>">
        <li><?php
        //get field object PAGE_TITLE from the specific page ID
    ...
    <a href="<?php echo get_permalink($impressum) . $languageURL; ?>">
        <li><?php
        //get field object PAGE_TITLE from the specific page ID
